    ...
    async def voice_update(self,member:discord.Member,before,after):
        ...
        if before.channel!=after.channel and after.channel==Vc_Creator:
            overwrites={
                ...
                member.guild.get_member(os.environ["BOT_ID"]):discord.PermissionOverwrite(view_channel=True,manage_channels=True,manage_permissions=True,manage_roles=True)}
